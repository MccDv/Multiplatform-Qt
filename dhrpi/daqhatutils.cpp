...
DaqHatUtils::DaqHatUtils()
{

}

void DaqHatUtils::delay(int milliSeconds)
{
...
double DaqHatUtils::getVoltsFromResolution(int resolution, double rangeVoltsMin, double rangeVoltsMax, int counts)
{
...
double DaqHatUtils::getVoltsFromCounts(int maxCode, double voltsMin, double voltsMax, int counts)
{
    double LSB, bipOffset, calcVolts;
...
QString DaqHatUtils::getFuncGroupName(UtFunctionGroup funcGroup)
{
    switch (funcGroup) {
...
QString DaqHatUtils::getOptionNames(uint32_t curOptions)
{
    QString optString;
...
QString DaqHatUtils::getErrorDescription(int response)
{
    switch (response) {
    case RESULT_SUCCESS:
...
QString DaqHatUtils::getStatusText(uint16_t status)
{
...
QString DaqHatUtils::getTrigText(TriggerMode trigType)
{
    switch (trigType) {
...
QString DaqHatUtils::getTcTypeName(uint8_t tcType)
{
    switch (tcType) {
    case TC_TYPE_J:
        return "J";
...
QVector<uint8_t> DaqHatUtils::getTcTypesFromString(QString tcTypes)
{
    QString  chanString;
...
QString DaqHatUtils::setTcTypeInString(QString tcTypes, uint8_t chan, uint8_t newType)
{
    QString typePrefs;
...
QString DaqHatUtils::getConfigItemName(uint8_t configItem)
{
    switch (configItem) {
    case DIO_DIRECTION:
        return "DIRECTION";
...
QString DaqHatUtils::getSourceText(uint8_t sourceClockTrig)
{
...
QString DaqHatUtils::getRangeText(uint8_t range)
{
    switch (range) {
...
QString DaqHatUtils::getModeText(uint8_t mode)
{
    switch (mode) {
    case A_IN_MODE_SE:
        return "Single-ended";
...
QString DaqHatUtils::getHatTypeName(uint16_t hatType)
{
    switch (hatType) {
    case HAT_ID_MCC_118:
        return "MCC118";
...
uint16_t DaqHatUtils::getHatIdFromName(QString hatName)
{
    if(hatName == "MCC118")
