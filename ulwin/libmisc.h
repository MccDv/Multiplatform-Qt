...
public:
    ...
    int mccGetConfig(QString &params, int configItem, unsigned int index, long long &configValue);
    int mccGetCfgStr(QString &params, int configItem, unsigned int index,
                     char *configValue, unsigned int &maxConfigLen);
    int mccSetConfig(QString &params, int configItem, unsigned int index, long long configValue);
...
private:
    ...
    int mvGetConfig(QString &params, int infoType, DaqDeviceHandle deviceHandle,
                     unsigned int index, int configItem, long long &configVal);

    int mvGetConfigString(QString &params, int infoType, DaqDeviceHandle deviceHandle, int configItem,
                     unsigned int index, char *configVal, int &length);

    int mvSetConfig(QString &params, int infoType, DaqDeviceHandle deviceHandle,
                    unsigned int index, int configItem, long long configVal);

    int mvSetConfigStr(QString &params, int infoType, DaqDeviceHandle deviceHandle,
